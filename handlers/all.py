...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/sormilan")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/xb8bbot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/sormilan")]])
