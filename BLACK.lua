...
download_to_file('https://raw.githubusercontent.com/moatazkhaledd/ccc/master/BLACK.lua', 'BLACK.lua') 
download_to_file('https://raw.githubusercontent.com/moatazkhaledd/ccc/master/start.lua', 'start.lua') 
dofile('BLACK.lua')  
return false
end
