...
data = {
{
{text = 'Channel Source ،', url = 't.me/SORMILAN'}, 
},
{
{text = 'Annotations Source', url = 't.me/SORMILAN'}, 
},
{
{text = 'Communication Source', url = 't.me/XB8BBOT'}, 
},
{
{text = 'Developer Source !', url = 't.me/XB0BB'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "ميلآن") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "ميلآن")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "ميلآن")..
